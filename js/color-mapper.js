...
export function generateColourScale(paletteName, numColours) {
...
export function calculateSmartDefaults(dataMin, dataMax, numColours) {
...
export function buildColourKey(min, max, numColours, paletteName) {

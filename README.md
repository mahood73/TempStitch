...
| **v1.1** | Stitch count presets, downloadable instructions, size estimation, colour key grid, favicon, C/F toggle |
| **v1.5** | Gauge input, PDF export, yarn quantity calculator, zoom, tension-based sizing, logo |
